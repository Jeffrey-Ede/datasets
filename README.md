...
This repository is for the [preprint](https://arxiv.org/abs/2003.01113)|[paper](https://dx.doi.org/10.1088/2632-2153/ab9c3c) "Warwick Electron Microscopy Datasets". It supplements datasets by providing scripts used to curate datasets and their variants, and to create both static and interactive visualizations.
